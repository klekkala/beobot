...
if("TRUE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX /home/pi/catkin_ws/src/src/rospack)
  set(rospack_DEVEL_PREFIX /home/pi/catkin_ws/src/devel_isolated/rospack)
...
if(NOT "/home/pi/catkin_ws/src/src/rospack/include;/usr/include " STREQUAL " ")
  set(rospack_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws/src/src/rospack/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/src/rospack/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/src/devel_isolated/rospack/lib;/opt/ros/kinetic/lib)
