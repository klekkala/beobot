...
if("TRUE" STREQUAL "TRUE")
  set(rosmake_SOURCE_PREFIX /home/pi/catkin_ws/src/src/ros/rosmake)
  set(rosmake_DEVEL_PREFIX /home/pi/catkin_ws/src/devel_isolated/rosmake)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosmake' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/src/ros/rosmake/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/src/devel_isolated/rosmake/lib;/opt/ros/kinetic/lib)
