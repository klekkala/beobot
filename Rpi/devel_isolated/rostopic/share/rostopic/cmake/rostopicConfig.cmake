...
if("TRUE" STREQUAL "TRUE")
  set(rostopic_SOURCE_PREFIX /home/pi/catkin_ws/src/src/ros_comm/rostopic)
  set(rostopic_DEVEL_PREFIX /home/pi/catkin_ws/src/devel_isolated/rostopic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rostopic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/src/ros_comm/rostopic/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/src/devel_isolated/rostopic/lib;/opt/ros/kinetic/lib)
