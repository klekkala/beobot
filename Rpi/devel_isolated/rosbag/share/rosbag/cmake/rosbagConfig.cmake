...
if("TRUE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /home/pi/catkin_ws/src/src/ros_comm/rosbag)
  set(rosbag_DEVEL_PREFIX /home/pi/catkin_ws/src/devel_isolated/rosbag)
...
if(NOT "/home/pi/catkin_ws/src/src/ros_comm/rosbag/include " STREQUAL " ")
  set(rosbag_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws/src/src/ros_comm/rosbag/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/src/ros_comm/rosbag/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/src/devel_isolated/rosbag/lib;/opt/ros/kinetic/lib)
