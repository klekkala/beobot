...
if("TRUE" STREQUAL "TRUE")
  set(rosnode_SOURCE_PREFIX /home/pi/catkin_ws/src/src/ros_comm/rosnode)
  set(rosnode_DEVEL_PREFIX /home/pi/catkin_ws/src/devel_isolated/rosnode)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/src/ros_comm/rosnode/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/src/devel_isolated/rosnode/lib;/opt/ros/kinetic/lib)
